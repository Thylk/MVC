...
import fr.doranco.eboutique.entity.Role;
...
//		frame.setUndecorated(true);
	...
	private JPanel getPanelConnection() {
		...
		buttonSeConnecter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (isConnected) {
					labelIsConnected.setText("Vous êtes bien connecté");
		...
		JLabel labelCreerCompte = new JLabel("Cliquez ici pour créer un nouveau compte...");
	...
	private JPanel getPanelCreerCompte() {
		...
		JButton buttonValider = new JButton("Créer compte");
		buttonValider.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				boolean compteCheck = ActionBean.creerCompte(textNom.getText(), textPrenom.getText(), comboBoxAge.getSelectedItem().toString(),
